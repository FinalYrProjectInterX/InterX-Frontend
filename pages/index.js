  ...
  return (
    <div class="bg-gray-900 min-h-screen">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto flex flex-col justify-center items-center min-h-screen">
          <div class="max-w-xl lg:max-w-lg my-20">
          ...
          <dl class="flex items-center justify-around">
            <div class="flex flex-col items-start w-[20%]">
              ...
              <dt class="mt-4 font-semibold text-white">Read</dt>
            ...
            <div class="flex flex-col items-start w-[20%]">
              ...
              <dt class="mt-4 font-semibold text-white">Contribute</dt>
