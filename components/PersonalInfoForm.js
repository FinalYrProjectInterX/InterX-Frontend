  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      ...
      <div className="mb-4 text-black w-1/2">
				...
				<input type="text" id="password" className="shadow-sm rounded-md w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" placeholder="your@email.com" onChange={handlePasswordChange} required />
			</div>
      <button
